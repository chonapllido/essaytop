...
public class SalesCommand extends GenericCommand {
	...
	/**
	 * @return the used_refund
	 */
	public String getUsed_refund() {
		return used_refund;
	}
	/**
	 * @param used_refund the used_refund to set
	 */
	public void setUsed_refund(String used_refund) {
		this.used_refund = used_refund;
	}
	/**
