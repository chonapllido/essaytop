...
public class EgovCcmZipManageController {
	...
	@RequestMapping(value = "/sym/ccm/zip/EgovCcmZip.do")
	public ModelAndView selectZip(@ModelAttribute("loginVO") LoginVO loginVO, @ModelAttribute("searchVO") ZipVO searchVO, ModelMap model) throws Exception {
		ModelAndView mav = new ModelAndView();
		mav.setViewName("support.zipcode");

		if (StringUtils.isEmpty(searchVO.getSearchKeyword())) {
			return mav;
		}
		...
		mav.addObject(Constants.CMD_VALUE, CmmnCodeList);
		return mav;
	}
