...
public class EgovMberManageServiceImpl extends EgovAbstractServiceImpl implements EgovMberManageService {
	...
	public String insertMber(MberManageVO mberManageVO) throws Exception  {
		...
		mberManageDAO.insertMberScrty(mberManageVO);
	...
	public void updateStatus(MberManageVO mberManageVO) {
		mberManageDAO.updateStatus(mberManageVO);
	}
	...
	public MberManageVO selectPassword2(MberManageVO passVO) {
		MberManageVO mberManageVO = mberManageDAO.selectPassword2(passVO);
		return mberManageVO;
	}
	
	public String searchId(MberManageVO mberVO) {
		String id = mberManageDAO.searchId(mberVO);
		return id;
