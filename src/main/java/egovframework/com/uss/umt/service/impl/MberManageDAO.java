...
public class MberManageDAO extends EgovComAbstractDAO{
	...
	public String insertMberScrty(MberManageVO mberManageVO){
    	return (String)getSqlMapClientTemplate().insert("mberManageDAO.insertMberScrty_S", mberManageVO);
    }
    ...
    public void updateStatus(MberManageVO mberManageVO) {
        update("mberManageDAO.updateStatus_S", mberManageVO);
    }
    /**
    ...
    public MberManageVO selectPassword2(MberManageVO mberManageVO){
    	return (MberManageVO) selectByPk("mberManageDAO.selectPassword2_S", mberManageVO);
    }
    
    public String searchId(MberManageVO mberManageVO){
    	return (String) selectByPk("mberManageDAO.searchId_S", mberManageVO);
    }
