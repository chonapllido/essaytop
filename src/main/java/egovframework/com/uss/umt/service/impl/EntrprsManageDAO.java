...
public class EntrprsManageDAO extends EgovComAbstractDAO{
    ...
    public String insertEntrprsmberScrty(EntrprsManageVO entrprsManageVO){
        return (String)getSqlMapClientTemplate().insert("entrprsManageDAO.insertEntrprsScrty_S", entrprsManageVO);
    }
    ...
    public void updateStatus(EntrprsManageVO entrprsManageVO) {
    	update("entrprsManageDAO.updateStatus_S", entrprsManageVO);
    }
    ...
    public EntrprsManageVO selectPassword2(EntrprsManageVO entrprsManageVO){
    	return (EntrprsManageVO) selectByPk("entrprsManageDAO.selectPassword2_S", entrprsManageVO);
    }
    
    public String searchId(EntrprsManageVO entrprsManageVO){
    	return (String) selectByPk("entrprsManageDAO.searchId_S", entrprsManageVO);
    }
