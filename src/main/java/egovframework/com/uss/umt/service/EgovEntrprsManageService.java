...
public interface EgovEntrprsManageService {
	...
	public void updateStatus(EntrprsManageVO entrprsManageVO) throws Exception;
	/**
	...
	public EntrprsManageVO selectPassword2(EntrprsManageVO passVO) throws Exception;
	/**
	...
	public String searchId(EntrprsManageVO entrprsManageVO) throws Exception;
