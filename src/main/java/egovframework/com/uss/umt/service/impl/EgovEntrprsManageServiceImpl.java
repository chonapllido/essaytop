...
public class EgovEntrprsManageServiceImpl extends EgovAbstractServiceImpl implements EgovEntrprsManageService {
    ...
    public String insertEntrprsmber(EntrprsManageVO entrprsManageVO) throws Exception  {
		...
		entrprsManageDAO.insertEntrprsmberScrty(entrprsManageVO);
	...
	public void updateStatus(EntrprsManageVO entrprsManageVO) {
		entrprsManageDAO.updateStatus(entrprsManageVO);
	}
	...
	public EntrprsManageVO selectPassword2(EntrprsManageVO passVO) {
		EntrprsManageVO entrprsManageVO = entrprsManageDAO.selectPassword2(passVO);
		return entrprsManageVO;
	}
	
	public String searchId(EntrprsManageVO entrprsVO) {
		String id = entrprsManageDAO.searchId(entrprsVO);
		return id;
	}
