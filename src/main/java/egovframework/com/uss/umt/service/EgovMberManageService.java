...
public interface EgovMberManageService {
	...
	public void updateStatus(MberManageVO mberManageVO) throws Exception;
	/**
	...
	public MberManageVO selectPassword2(MberManageVO passVO) throws Exception;
	
	public String searchId(MberManageVO mberManageVO) throws Exception;
