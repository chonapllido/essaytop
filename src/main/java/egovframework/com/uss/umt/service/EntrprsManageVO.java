...
public class EntrprsManageVO  extends UserDefaultVO{
	...
	/**
	 * applcntTelno attribute 값을  리턴한다.
	 * @return String
	 */
	public final String getApplcntTelno() {
		return applcntTelno;
	}
	/**
	 * applcntNm attribute 값을 설정한다.
	 * @param applcntTelno String
	 */
	public final void setApplcntTelno(String applcntTelno) {
	 ...
	 * @param induty String
	 */
	public final void setInduty(String induty) {
		this.induty = induty;
	}
	/**
	 * category attribute 값을  리턴한다.
	 * @return String
	 */
	...
	/**
	 * billEmail attribute 값을 설정한다.
	 * @param billEmail String
	 */
