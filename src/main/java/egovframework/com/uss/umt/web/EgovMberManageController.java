...
public class EgovMberManageController {
    ...
    public String sbscrbMberView(
        ...
        if(!"".equals((String)request.getParameter("realname"))){
        	model.addAttribute("mberNm",   (String)request.getParameter("realname"));    //실명인증된 이름 - 주민번호 인증
            model.addAttribute("ihidnum",   (String)request.getParameter("ihidnum"));      //실명인증된 주민등록번호 - 주민번호 인증
        }
        if(!"".equals((String)request.getParameter("realName"))){
        	model.addAttribute("mberNm",   (String)request.getParameter("realName"));      //실명인증된 이름 - ipin인증
        }
