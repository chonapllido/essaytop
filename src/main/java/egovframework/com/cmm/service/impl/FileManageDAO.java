...
public class FileManageDAO extends EgovComAbstractDAO {
	...
	/**
	 * 하나의 파일을 삭제한다. (DEL_yn 추가 업데이트로 변경)
	 *
	 * @param fvo
	 * @throws Exception
	 */
	public void deleteFileInf(FileVO fvo) throws Exception {
		update("FileManageDAO.deleteFileDetail", fvo);
	}
	...
	public FileVO selectFileInf(FileVO fvo) throws Exception {
		return (FileVO) getSqlMapClientTemplate().queryForObject("FileManageDAO.selectFileInf", fvo);
	}
	 ...
	 */
	@SuppressWarnings("deprecation")
	public FileVO selectStdPicture(FileVO fvo) throws Exception {
		return (FileVO) getSqlMapClientTemplate().queryForObject("FileManageDAO.selectStdPicture", fvo);
	}
