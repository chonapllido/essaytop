...
public class ImagePaginationRenderer extends AbstractPaginationRenderer implements ServletContextAware{
	...
	public void initVariables(){
		...
		*/
		...
		firstPageLabel    = "<li class='paging-first'><a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" class='first'>&nbsp;</a></li>";
        previousPageLabel = "<li class='paging-prev'><a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" class='prev'>&nbsp;</a></li>";
        currentPageLabel  = "<li class='now-page'><a href='#'>{0}</a></li>";
        otherPageLabel    = "<li><a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \" style='border:1px solid'>{2}</a></li>";
        nextPageLabel     = "<li class='paging-next'><a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">&nbsp;</a></li>";
        lastPageLabel     = "<li class='paging-last'><a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">&nbsp;</a></li>";
	}
