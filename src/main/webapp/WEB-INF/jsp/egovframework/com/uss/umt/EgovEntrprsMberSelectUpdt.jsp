...
<body>
        ...
        <!-- for validation -->
	    <input type="hidden" name="entrprsMberPassword" id="password" value="Test#$123)"/>
        ...
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            ...
            <tr>
            	<th width="20%" height="23" class="required_text" nowrap>업태&nbsp;&nbsp;</th>
            	<td width="80%" nowrap><label for="category">
            		<form:input path="category" id="category" cssClass="txaIpUmt" size="50" maxlength="100" /></label>
            ...
            <tr>
            	<th width="20%" height="23" class="required_text" nowrap>종목&nbsp;&nbsp;</th>
            	<td width="80%" nowrap><label for="induty">
            		<form:input path="induty" id="induty" cssClass="txaIpUmt" size="50" maxlength="100" /></label>
            		<div><form:errors path="induty" cssClass="error"/></div>
            	</td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <tr>
                <th width="20%" height="23" class="required_text" nowrap >세금계산서 메일&nbsp;&nbsp;</th>
                <td width="80%" nowrap><label for="billEmail">
                    <form:input path="billEmail" id="billEmail" cssClass="txaIpUmt" size="20" maxlength="40" /></label>
                    <div><form:errors path="billEmail" cssClass="error"/></div>
                </td>
            </tr>
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
            ...
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >신청자이메일주소&nbsp;&nbsp;</th>
                <td width="80%" nowrap><label for="applcntTelno">
                    <form:input path="applcntTelno" id="applcntTelno" cssClass="txaIpUmt" size="30" maxlength="30" /></label>
                    <div><form:errors path="applcntTelno" cssClass="error"/></div>
                </td>
            </tr>
            <tr>
                <th width="20%" height="23" class="required_text" nowrap >
