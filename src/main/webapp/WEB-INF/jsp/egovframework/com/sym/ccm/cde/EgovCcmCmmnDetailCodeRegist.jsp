...
<!-- -상단타이틀 -->
<form:form commandName="cmmnDetailCode" name="cmmnDetailCode" method="post" onsubmit="return fn_egov_regist_CmmnDetailCode(this);">
...
<CAPTION style="display: none;">공통상세코드 등록</CAPTION>
  ...
  <tr>
    ...
    <td width="80%" nowrap>
      <form:input  path="code" size="15" maxlength="30" id="code"/>
...
-->  
  <td><span class="button"><input type="button" value="목록" onclick="fn_egov_list_CmmnDetailCode(); return false;"></span></td>  
  <td width="10"></td>
  <td><span class="button"><input type="submit" value="저장"></span></td>
</tr>
</table>
